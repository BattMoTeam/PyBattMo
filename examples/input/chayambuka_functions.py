...
data_pe_ocp = pd.read_csv(
    os.path.join(base_path, os.path.join("data", "Chayambuka_pe_ocp.csv")), header=None
)
data_ne_ocp = pd.read_csv(
    os.path.join(base_path, os.path.join("data", "Chayambuka_ne_ocp.csv")), header=None
)
data_pe_D = pd.read_csv(
    os.path.join(base_path, os.path.join("data", "Chayambuka_pe_D.csv")), header=None
)
data_ne_D = pd.read_csv(
    os.path.join(base_path, os.path.join("data", "Chayambuka_ne_D.csv")), header=None
)
data_pe_k = pd.read_csv(
    os.path.join(base_path, os.path.join("data", "Chayambuka_pe_k.csv")), header=None
)
data_ne_k = pd.read_csv(
    os.path.join(base_path, os.path.join("data", "Chayambuka_ne_k.csv")), header=None
)
data_elyte_cond = pd.read_csv(
    os.path.join(base_path, os.path.join("data", "Chayambuka_elyte_conductivity.csv")), header=None
)
data_elyte_diff = pd.read_csv(
    os.path.join(base_path, os.path.join("data", "Chayambuka_elyte_D.csv")), header=None
)
